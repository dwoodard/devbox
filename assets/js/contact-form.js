	...
	$("a#submit").click(function(){
		...
		$.ajax({
			...
			success: function(){
				$('.error').fadeOut(0);
				$('form#contact-form').clearForm();
				$('#contact_form').html("<div class='download-box'><div><p>Contact form submitted!</p></div></div>")
					.append("<br><label for='message'><b>&nbsp;We will be in touch soon.</b></label>")
					.fadeOut(0)
					.fadeIn(1500, function(){
						$('#contact_form').append("<br><br><a href='#' id='back' class='button1' onclick='window.location.reload(); return false;'>Back</a>");
						//Cufon.refresh();
